    ...
    <div class="container-fluid">
        ...
        <main class="main m-2">
            ...
            <div class="row justify-content-center mt-5">
                ...
                <a href="" class="n-level n__level__no_content col-3 d-flex justify-content-center align-content-center border p-1"><img src="./images/n4-tab.png" alt=""></a>
                <a href="" class="n-level n__level__no_content col-3 d-flex justify-content-center align-content-center border p-1"><img src="./images/n3-tab.png" alt=""></a>
                <a href="" class="n-level n__level__no_content col-3 d-flex justify-content-center align-content-center border p-1"><img src="./images/n2-tab.png" alt=""></a>
            </div>
        </main>
